...
- Você é responsável por preencher os {{placeholders}} com informações fidedignas, extraídas do PDF ou arquivo Markdown fornecido com este prompt, que se compõe das Alegações Finais (se disponíveis), da Sentença e das Razões de Recurso.
...
## INSTRUÇÕES
- A partir dos dados encontrados em um PDF ou Markdown carregado, gere a minuta de contrarrazões e a apresente na forma do template abaixo, como texto na conversa. Não grave arquivo, salvo pedido expresso do usuário.
